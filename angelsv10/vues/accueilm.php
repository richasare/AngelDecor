...
<img src='Images/logo5.png' style="width:40vw;height:12vh;"  >
...
<div id='de'style="background-image: url('Images/fondb.jpg');opacity: 1;border-radius: 10px;display:block;text-align:center;height:22vh;width:40vw;margin-left:2vh">
    <br>
    <a class="nav-link"  data-toggle="modal" data-target="#myModal"><img src="Images/devis2.png" id="dei" style="max-width:70%;height:auto;opacity:1;"></a>
