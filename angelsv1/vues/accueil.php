        ...
        <div class="row" style="z-index:1;position:absolute">
            <img src='Images/ph5.png' style="width:179%; max-width:179% ; height:475.583px" >
            </div >
            <center>
...
<div class="container">
  <div class="row">
    ...
    <div id='de'class="col"style="background-color: #ffffff;opacity: 0;border-radius: 10px;border:3px solid #a88230">
    <a class="nav-link" href="index.php?uc=Devis" data-toggle="modal" data-target="#myModal"><img src="Images/devis.png" id="dei" style="width:200px;height:200px;opacity:1;margin-left: 180px"></a>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <input type="button" name="mailform" class="btn btn-warning" value="Envoi">
            </div>
          </div>
        </div>
      </div>
