...
<div class="container">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="Images/ph1.png" alt="First slide" style="border-radius: 10px;">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="Images/ph2.png" alt="Second slide" style="border-radius: 10px;">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="Images/ph3.png" alt="Third slide" style="border-radius: 10px;">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <div id='de'class="col"style="background-color: #ffffff;opacity: 0;border-radius: 10px;border:3px solid #a88230;display:block;text-align:center;width:42vw;max-width:150vw;">
    <br>
...
<div class="elfsight-app-32a70f63-1e28-4929-9ea4-4beb3142db4c"></div>
    </div>
    <div class="col">
