function alerte(){
    ...
    window.alert("L'adresse mail est vide !");
            ...
            window.alert("L'adresse mail ne contient pas de '@' !");
                }
        else if (tel==""){
...
mouseTarget3.addEventListener('mouseenter', e => {
    ...
    if(screen.width<1000){
        cdr1=document.getElementById("cd0");
        console.log("petit")
        cdr1.style.width="100vw";
        cdr2=document.getElementById("cd10");
        cdr2.style.width="95vw";
        img=document.getElementById("im1");
        //img.style.clip="rect(auto, 50vw, auto, auto)";
        img.style.width="100vw";
        d1=document.getElementById("de");
        d2=document.getElementById("de2");
        di=document.getElementById("dei");
        d1.style.flex="none";
        d2.style.flex="none";
        d1.style.width="84vw";
        d2.style.width="88vw";
        d1.style.marginLeft="5vw"
        d2.style.marginLeft="3vw"
