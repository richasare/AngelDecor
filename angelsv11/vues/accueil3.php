...
<div style="margin-top:25px;position:absolute;z-index:6">
  ...
  <a data-toggle="modal" data-target="#myModal" href="#">
    <div class="card" id="cr2" style="width: 22rem;text-align:center;margin-left:25vw ">
...
<div style='position:absolute;z-index:6;margin-top:1300px;text-align:center;width:70vw;margin-left:7vw;'>
  ...
  <div style='position:absolute;z-index:6;margin-top:30px;text-align:center;width:70vw;margin-left:0vw;'>
     <h3 style="opacity:1; width:70vw; color:white;margin-left:10vw;text-shadow:2px 3px 1px black; margin-top:0px;">Spécialisée dans la pose et la restauration de parquets de haute qualité, Angels Décor est une jeune société composée de professionnels expérimentés et passionnés menés par Angel Tonev. Notre exigence de produire chaque fois un travail d'exception nous vaut la satisfaction de nos clients et la reconnaissance de nos paires. Basée au Pré-Saint-Gervais (93), notre champ d'action s'étend à toute la France et au-delà.</h3>
     </div>
</div>
