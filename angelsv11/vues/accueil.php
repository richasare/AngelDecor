...
<script>
 RedirectionJavascript();
        ...
        <div class="row" style="z-index:1;position:absolute">
            <img id="im1" src='Images/bois.jpg' style=" width:105vw ; height:475.583px" >
            </div >
            ...
            <cadre2 id="cd10" >
            <img id="cd1"src='Images/logo.png' style="width:140px;height:110px;opacity:0"  >
            <br>
            <br>
            <br>
...
<p style="text-align: center"><font size="5" color="black" ><span style="border-bottom: 3px solid #a88230" >NOS FONCTIONNALITÉS</span></font></p>
<div class="container" >
  <div class="row">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="Images/ph3.png" alt="Third slide" style="border-radius: 10px;width:41vw;height:60vh;">
    </div>
  </div>

</div>
    </div>
    <div style="z-index:2;position:absolute;width:43vw ;height:60vh;">
            <cadre3 style="border-radius: 5px 10px 10px 5px;background-color: rgb(0, 0, 0);width:41.3vw ;height:60vh;display:inline-block;opacity:0;text-align:center;"id="dc0">
            <a href="https://www.google.com/maps/uv?pb=!1s0x47e663ac32461f05%3A0xe7b79ac4ba26cb00!3m1!7e115!4shttps%3A%2F%2Flh5.googleusercontent.com%2Fp%2FAF1QipOK57PxhaE4XVXNEoa_AF0ASAtDrxDQSzjcNOiD%3Dw213-h160-k-no!5sangels%20decor%20-%20Recherche%20Google!15sCgIgAQ&imagekey=!1e10!2sAF1QipOK57PxhaE4XVXNEoa_AF0ASAtDrxDQSzjcNOiD&hl=fr&sa=X&ved=2ahUKEwiYg7HRscL1AhVKzoUKHSrTBDgQoip6BAghEAM"><img src="Images/galerie3.png" id="gal" style="max-width:50%;height:auto;opacity:1;margin-top:10vh"></a>
            </cadre3>
            </div>
    ...
    <br>
    <a class="nav-link"  data-toggle="modal" data-target="#myModal"><img src="Images/devis.png" id="dei" style="max-width:50%;height:auto;opacity:1;"></a>
    ...
    <p style="text-align: center"><font id="fo"size="4" color="#a88230" >VOTRE DEVIS SOUS 24H</font></p>
    </div>
    </div>
    </div>
