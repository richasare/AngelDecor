...
<script>
 RedirectionJavascript();
        ...
        <div class="row" style="z-index:1;position:absolute">
            <img id="im1" src='Images/ph5.png' style=" max-width:100vw ; height:475.583px" >
            </div >
...
<div class="container" >
  ...
  <div class="carousel-inner">
    ...
    <div style="z-index:2;position:absolute;width:40vw ;height:60vh;">
            <cadre3 style="border-radius: 5px 10px 10px 5px;background-color: rgb(0, 0, 0);width:40vw ;height:60vh;display:inline-block;opacity:0.5;text-align:center;"id="dc0">
